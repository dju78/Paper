...
const websiteJsonLd = {
  ...
  '@type': 'WebSite',
  name: 'D.J. Omoyele — Research & Publications',
  url: 'https://omoyelejd.co.uk',
  description: 'An academic publication hub and research archive by D.J. Omoyele, Economist and Senior Data Analyst.',
  author: {
    '@type': 'Person',
    name: 'D.J. Omoyele',
      ...
      <div className="container">
        <div style={{ maxWidth: '800px', marginBottom: '5rem', paddingTop: '1rem' }}>
          ...
          <p style={{ fontSize: '1.1rem', lineHeight: '1.9', marginBottom: '1.25rem', color: 'var(--text-main)' }}>
            D.J. Omoyele is an economist, Chartered Accountant, and senior data analyst whose work focuses on the intersection of public policy, regulatory governance, digital administration, and applied economic analysis. His research explores how institutions, compliance systems, and administrative design influence economic outcomes, public accountability, and state capacity.
          </p>
          <p style={{ fontSize: '1.1rem', lineHeight: '1.9', marginBottom: '1.25rem', color: 'var(--text-main)' }}>
